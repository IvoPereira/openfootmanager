...
pub fn run() {
    ...
    let result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            write_temp_database,
            list_world_editor_projects,
            create_world_editor_project,
            open_world_editor_project,
            save_world_editor_project,
            validate_world_editor_project,
            import_world_editor_asset,
            publish_world_editor_project,
            select_team,
            get_saves,
            load_game,
            get_active_game,
